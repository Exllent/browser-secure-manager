const secureBrowserWebGLConfig = __SECURE_BROWSER_CONFIG__;
const secureBrowserWebGLCanvases = new WeakMap();
const secureBrowserWebGLNoiseSeed = secureBrowserWebGLConfig.noiseSeed;
...
const patchWebGLPrototype = (prototype) => {
    ...
    prototype.getParameter = new Proxy(originalGetParameter, {
        apply(target, thisArg, args) {
            ...
            if (parameter === 37445) return secureBrowserWebGLConfig.vendor;
            if (parameter === 37446) return secureBrowserWebGLConfig.renderer;
            return Reflect.apply(target, thisArg, args);
        }
    });
